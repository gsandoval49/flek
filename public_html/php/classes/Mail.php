...
class Mail implements \JsonSerializable {
	 ...
	 * @return \TypeError if new id is not an integer
	 * */
...
//enforce that the messageId is not null (don't update a message that that hasn't been inserted)
		...
		/*create query template*/
		$query = "UPDATE mail SET mailSubject = :mailSubject, mailSenderId = :mailSenderId, mailReceiverId = :mailReceiverId, mailGunId = :mailGunId, mailContent = :mailContent WHERE mailId = :mailId";
		$statement = $pdo->prepare($query);
	...
	/**
	 * gets all messages
	 *pdo was removed and test was commented out
	 * */
